...
class GaddagConverterTest {
    ...
    private <A> void executeTestCases(TestCase testCase, Gaddag<A> gaddag) {
        ...
        switch (testCase.testType) {
            case WORD -> Assertions.assertEquals(TestUtils.isWordPresent(testCase.word, gaddag), testCase.expected);
            case SEQUENCE -> Assertions.assertEquals(TestUtils.isSequencePresent(testCase.word, gaddag), testCase.expected);
